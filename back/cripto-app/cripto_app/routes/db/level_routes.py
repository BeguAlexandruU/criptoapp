...
from cripto_app.db.models import Level
from cripto_app.db.crud import CrudBase
from cripto_app.db.schemas.level_s import LevelBase, LevelCreate
...
async def create_entity(entity: LevelCreate, db: DBD):
    res = await crud.create(db, entity)
    return res

@router.put("/update", status_code=status.HTTP_200_OK)
async def update_entity(entity: LevelBase, db: DBD):
