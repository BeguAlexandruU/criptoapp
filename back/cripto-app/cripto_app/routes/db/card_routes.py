...
from cripto_app.db.models import Card
from cripto_app.db.crud import CrudBase
from cripto_app.db.schemas.card_s import CardBase, CardCreate
...
async def create_entity(entity: CardCreate, db: DBD):
    res = await crud.create(db, entity)
    return res

@router.put("/update", status_code=status.HTTP_200_OK)
async def update_entity(entity: CardBase, db: DBD):
