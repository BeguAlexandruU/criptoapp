...
from cripto_app.db.models import Referal
from cripto_app.db.crud import CrudBase
from cripto_app.db.schemas.referal_s import ReferalBase, ReferalCreate
...
async def create_entity(entity: ReferalCreate, db: DBD):
    res = await crud.create(db, entity)
    return res

@router.put("/update", status_code=status.HTTP_200_OK)
async def update_entity(entity: ReferalBase, db: DBD):
